...
{
    /* Format strings */
    static char fmt_9994[] = "(\002 Tests of the COMPLEX*16 LAPACK ZCGESV ro"
	    "utines \002,/\002 LAPACK VERSION \002,i1,\002.\002,i1,\002.\002,"
	    "i1,//\002 The following parameter values will be used:\002)";
    ...
    extern /* Subroutine */ int ilaver_(integer *, integer *, integer *), 
	    zerrab_(integer *), zdrvab_(logical *, integer *, integer *, 
	    integer *, integer *, doublereal *, integer *, doublecomplex *, 
	    doublecomplex *, doublecomplex *, doublecomplex *, doublecomplex *
, doublereal *, complex *, integer *, integer *);
    doublereal thresh;
    logical dotype[30];
    integer ntypes;
...
/*     Test the error exits */
    ...
    if (tstdrv) {
	zdrvab_(dotype, &nm, mval, &nns, nsval, &thresh, &lda, a, &a[17424], 
